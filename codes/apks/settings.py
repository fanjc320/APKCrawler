...
ITEM_PIPELINES = {
    ...
    # 'apks.pipelines.page_content_pipeline.ContentPipeline': 100,  # 实际上走了这个
    # 'apks.pipelines.page_content_pipeline_fjc.ContentPipelineFjc': 100,  # 实际上走了这个
...
# FILES_STORE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../data/apks")
FILES_STORE = os.path.join("files_____1")
IMAGES_STORE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../../data/apks")
...
# USING_PROXY = False
# USING_PROXY = True
# PROXY_PATH = "http://127.0.0.1:10819"
# PROXY_PATH = "http://127.0.0.1:10818"
