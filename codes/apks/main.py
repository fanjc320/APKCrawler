...
@click.option("--market_name", "-m", default="apkpure", type=click.Choice(["fossdroid", "xiaomi", "apkpure", "github", "github_opensource"], case_sensitive=False), help="Market Name in ['fossdroid', 'xiaomi', 'apkpure', 'github', 'github_opensource']. Default is fossdroid.")
...
def main(market_name: str = "xiaomi", using_log_file: bool = False, log_level: str = "INFO", using_proxy: bool = False):
    ...
    print("mainpy begin to crawl log_level:" + log_level)
